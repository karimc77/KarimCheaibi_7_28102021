<template>
  <div class="flex justify-center w-screen py-20">
    <div
      class="w-full md:w-5/6 lg:w-3/6 bg-white py-5 rounded-xl shadow-2xl border-gray-300 border-opacity-0.7"
    >
      <div
      ...
      <div v-if="$store.state.posts == 0" class="flex justify-center m-28">
        <p class="text-center">
          Personne n'a encore publié par ici !<br />
          Et si vous partagez quelque chose en cliquant simplement sur le bouton
          ci-dessus ? 🙂
        </p>
      </div>
